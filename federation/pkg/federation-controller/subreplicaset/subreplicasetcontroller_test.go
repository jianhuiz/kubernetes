...
import (
	...
	federation_v1alpha1 "k8s.io/kubernetes/federation/apis/federation"
	...
	extensions_v1beta1 "k8s.io/kubernetes/pkg/apis/extensions"
...
func TestSyncReplicaSetUpdate(t *testing.T) {
	...
	manager := NewSubReplicaSetController(federationClientSet, 5)
