...
import (
	...
	"k8s.io/kubernetes/federation/pkg/federation-controller/util/identityprovider"
	userclusteridentityprovider "k8s.io/kubernetes/federation/pkg/federation-controller/util/identityprovider/usercluster"
)
