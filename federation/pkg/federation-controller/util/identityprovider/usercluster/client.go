...
type UserClusterIdentityCRDClient struct {
...
func NewUserClusterIdentityCRDClientForConfig(cfg *rest.Config) (*UserClusterIdentityCRDClient, *runtime.Scheme, error) {
	...
	return &UserClusterIdentityCRDClient{client, runtime.NewParameterCodec(crdScheme)}, crdScheme, nil
}

func (c *UserClusterIdentityCRDClient) UserClusterIdentity(namespace string) *userClusterIdentityClient {
