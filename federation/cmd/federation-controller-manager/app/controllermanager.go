...
import (
	...
	federationclientset_1_3 "k8s.io/kubernetes/federation/client/clientset_generated/federation_release_1_3"
...
func StartControllers(s *options.CMServer, restClientCfg *restclient.Config) error {
	...
	ccClientset := federationclientset_1_3.NewForConfigOrDie(restclient.AddUserAgent(restClientCfg, "cluster-controller"))
	...
	scClientset := federationclientset_1_3.NewForConfigOrDie(restclient.AddUserAgent(restClientCfg, servicecontroller.UserAgentName))
